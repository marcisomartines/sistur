...
<!--                        <li><a href="<?php echo base_url() . "index.php/home/orcamento" ?>"><i class="fa fa-file-text-o"></i> Orçamento</a></li>-->
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Cliente <small>Busca</small></h1>
                        <ol class="breadcrumb">
                ...
                <?php
                    ...
                    echo form_close();
                ?>
                <a href="<?php echo base_url() . "index.php/home/cliente?pagina=0" ?>" class="btn btn-warning" role="button"><i class='fa fa-refresh'></i> Limpar</a>
                    </div>
                </div><i class='fa fa-search'></i> Limpar
                <table class="table tablesorter table-striped">
                    ...
                    $query=$this->db->query("SELECT id_clients,nome,telefone,rg,celular,data_nascimento,loc_embarque
                                      FROM tb_clients WHERE nome like '%".$this->input->post('course')."%' ORDER BY nome asc"); 
