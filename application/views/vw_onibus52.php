<table class="table table-bordered table-hover table-striped tablesorter">
    <tr>
        <td colspan="5" align="center">PARTE DE CIMA</td>
    </tr>
    <tr><!--Linha 1-->
        <?php
        $this->db->select('*');
    ...
    ?>
        ...
        if ($query->num_rows() > 0) {
            ...
            <td class="danger">
                ...
                foreach ($query->result() as $rel) {
                    if ($rel->tipo == 'v' || $rel->tipo == 'p') {
                        echo form_open('home/editarReserva'); $count++;
                        ?>
...
<?php } ?>
        <!--FIM DA VERIFICACAO-->
        <td colspan="2"><table width="100%"><tr><td align="center">GUIA</td></tr><tr><td align="center">ENTRADA</td></tr></table></td>
    </tr>
    <tr><!--Linha 4-->
        <?php
        $this->db->select('*');
...
<?php } ?>
    ...
    <tr> 
        <td colspan="5" align="center">PARTE DE BAIXO</td>
    </tr>
    <tr>
        <?php
        $this->db->select('*');
            ...
            foreach ($query->result() as $rel) {
                if ($rel->tipo == 'v' || $rel->tipo == 'p') {
                    ...
                    ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="43">
                        </form>
                        <?php
                    }
                    if ($rel->tipo == 'i' || $rel->tipo == 'b') {
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="43">
                        </form>
                        <?php
                    }
                    if ($rel->tipo == 'd') {
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="43">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="43" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="43">
                </form>
        <?php
        }
    ?>
...
if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $rel) {
                if ($rel->tipo == 'v' || $rel->tipo == 'p') {
                    ...
                    ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="44">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="44">
                        </form>
            <?php
        }
        if ($rel->tipo == 'd') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="44">
                        </form>
                        <?php
                    }
                }
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="44" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="44">
                </form>
        <?php
        }
                ?>
    ...
    foreach ($query->result() as $rel) {
        if ($rel->tipo == 'v' || $rel->tipo == 'p') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="45">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="45">
                        </form>
                        <?php
                    }
                    if ($rel->tipo == 'd') {
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="45">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="45" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="45">
                </form>
        <?php
        }
    ?>
            ...
            <td class="danger">
                ...
                foreach ($query->result() as $rel) {
                    if ($rel->tipo == 'v' || $rel->tipo == 'p') {
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="46">
                        </form>
                        <?php
                    }
                    if ($rel->tipo == 'i' || $rel->tipo == 'b') {
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="46">
                        </form>
                        <?php
                    }
                    if ($rel->tipo == 'd') {
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="46">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="46" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="46">
                </form>
        <?php
        }
    ?>
...
if ($query->num_rows() > 0) {
    ...
    foreach ($query->result() as $rel) {
        if ($rel->tipo == 'v' || $rel->tipo == 'p') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="47">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="47">
                        </form>
            <?php
        }
        if ($rel->tipo == 'd') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="47">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="47" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="47">
                </form>
        <?php
        }
    ?>
...
if ($query->num_rows() > 0) {
    ...
    foreach ($query->result() as $rel) {
        if ($rel->tipo == 'v' || $rel->tipo == 'p') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="48">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="48">
                        </form>
            <?php
        }
        if ($rel->tipo == 'd') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="48">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="48" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="48">
                </form>
        <?php
        }
    ?>
...
if ($query->num_rows() > 0) {
    ...
    foreach ($query->result() as $rel) {
        if ($rel->tipo == 'v' || $rel->tipo == 'p') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="49">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="49">
                        </form>
            <?php
        }
        if ($rel->tipo == 'd') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="49">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="49" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="49">
                </form>
        <?php
        }
    ?>
...
if ($query->num_rows() > 0) {
    ...
    foreach ($query->result() as $rel) {
        if ($rel->tipo == 'v' || $rel->tipo == 'p') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="50">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="50">
                        </form>
            <?php
        }
        if ($rel->tipo == 'd') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="50">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="50" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="50">
                </form>
        <?php
        }
    ?>
...
if ($query->num_rows() > 0) {
    ...
    foreach ($query->result() as $rel) {
        if ($rel->tipo == 'v' || $rel->tipo == 'p') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="51">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="51">
                        </form>
            <?php
        }
        if ($rel->tipo == 'd') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="51">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="51" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="51">
                </form>
        <?php
        }
    ?>
...
if ($query->num_rows() > 0) {
    ...
    foreach ($query->result() as $rel) {
        if ($rel->tipo == 'v' || $rel->tipo == 'p') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-info pull-right" value="52">
                        </form>
            <?php
        }
        if ($rel->tipo == 'i' || $rel->tipo == 'b') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-warning pull-right" value="52">
                        </form>
            <?php
        }
        if ($rel->tipo == 'd') {
            ...
            ?>
                        ...
                        <input type="hidden" name="id_reservs" value="<?= $rel->id_reservs ?>" />
                        <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                        <input type="submit" title="<?=$rel->nome?>" class="btn btn-danger pull-right" value="52">
                        </form>
            <?php
        }
    }
    if($count<=1 && $count!=0){
            ...
            ?>
                <input type="hidden" name="nr_poltrona" value="52" />
                <input type="hidden" name="id_tour" value="<?= $this->input->post('id_tour') ?>" />
                <input type="submit" class="btn btn-success pull-right" value="52">
                </form>
        <?php
        }
    ?>
