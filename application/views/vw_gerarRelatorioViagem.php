        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table>
                        <tr>
                            <td align='right'><strong>Período: </strong><?= $data_inicio2 ?> à <?= $data_final2 ?> <strong>Destino: </strong> <?php if (empty($cidade->destino)) echo $cidade;
    else echo $cidade->destino; ?></td>
                        </tr>
                    </table>
                </div>
            </div><!-- /.row -->
