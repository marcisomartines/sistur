    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Orçamentos <small>Listagem</small></h1>
                        <ol class="breadcrumb">
                            <li class="active"><i class="fa fa-file-text-o"></i> Orçamentos</li>
                            <li class="pull-right"><a href="<?php echo base_url() . "index.php/home/orcamentoCadastro" ?>" class="btn btn-primary btn-xs" role="button">Novo Orçamento</a></li>
                        </ol>
                    </div>
                </div><!-- /.row -->
                ...
                <table class="table tablesorter">
                    ...
                    <?php
                    $this->db->order_by("id_budget", "asc");
                    $query = $this->db->get('tb_budgets');
                    foreach ($query->result() as $row) {
                        ...
                        <tr>
                            ...
                            <td width='180px'><?= form_open('home/excluirOnibus') ?>
                                ...
                                <input type="hidden" name="id_cars" value="<?= $row->id_cars ?>" />
                                <input type="submit" class="btn btn-success btn-xs pull-right" value="Efetivar">
                                </form>
                            </td>
                        </tr>
                        <?php
