        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row col-sm-4">
                    ...
                    echo form_input(['name' => 'data_nascimento', 'id' => 'data_nascimento', 'class' => 'form-control input-sm']);
                    echo '<br>';
                    echo form_label('RG: ');
                    ...
                    echo form_input(['name' => 'validade_cnh', 'id' => 'validade_cnh', 'class' => 'form-control input-sm']);
                    echo '<br>';
