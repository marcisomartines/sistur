...
<!--                                <li><a href="<?php echo base_url() . "index.php/home/relatorioOnibus" ?>"> Ônibus</a></li>-->
            ...
            <div id="page-wrapper">
                ...
                <div class="row col-sm-4">
                    ...
                    echo '<br>';
                    echo form_label('CNH: ');
                    echo "<td><input type='text' name='cnh' id='cnh' class='form-control input-sm'></td>";
                    echo '<br>';
                    echo form_label('Validade CNH: ');
                    echo "<td><input type='text' name='validade_cnh' id='validade_cnh' class='form-control input-sm'></td>";
                    echo '<br>';
                    ...
                    echo "<td><input type='text' name='onservacao' id='observacao' class='form-control input-sm'></td>";
