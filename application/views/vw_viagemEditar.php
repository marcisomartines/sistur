...
<!--fim do menu superior alinhado a direita-->
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1>Destino <small>Edição</small></h1>
            <ol class="breadcrumb">
              <li class="active"><i class="fa fa-tasks"></i><a href="<?php echo base_url()."index.php/home/viagem"?>"> Destino</a> / Editar</li>
            </ol>
          </div>
        </div><!-- /.row -->
<div class="row col-sm-4">
                    ...
                    echo form_input(['name' => 'destino', 'id' => 'destinoi', 'class' => 'form-control input-sm', 'value' => $viagemDados['destino']]);
                    echo '<br>';
